        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed mt-0.5">
                ศูนย์กลางการวิเคราะห์มูลค่าสินค้าคงคลัง, อัตราหมุนเวียน (Stock Turnover), ความหนาแน่นพื้นที่คลัง และแจ้งเตือนจุดสั่งซื้อซ้ำ
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-700 dark:text-slate-200 text-xs font-semibold flex items-center gap-1.5 hover:bg-slate-100 dark:hover:bg-slate-700 transition"
            >
