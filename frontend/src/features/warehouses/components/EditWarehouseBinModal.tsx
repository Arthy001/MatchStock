          ...
          <div className="flex items-center gap-3.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 font-normal mt-0.5 truncate">
                {isViewOnly
                  ? (isEn ? 'Inspect zone, rack, shelf positioning, and max capacity' : 'ดูข้อมูลโซน แร็ค ชั้นวาง และความจุสูงสุด')
                  : (isEn ? 'Update bin code, zone, rack, shelf, and max capacity' : 'แก้ไขรหัสตำแหน่ง โซน แร็ค ชั้นวาง และความจุสูงสุด (maxCapacity)')}
              </p>
            </div>
          </div>
          <button
