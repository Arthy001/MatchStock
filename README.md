...
| :---: | :--- | :--- | :--- |
| **1** | **Project Manager & System Analyst (PM + SA)** | **@Arthy001** (คุณ) | ภาพรวมโปรเจกต์, `/docs/`, API Specs, คุม Sprint & Releases |
...
| **4** | **QA / Tester** | **`dechasitbird@gmail.com`** (คุณเดชสิทธิ์) | `/tests/`, Test Matrix, Postman Testing, Bug Reports |
